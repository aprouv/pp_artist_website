...
const Home = () => {
  return (
    <Banner>
      ...
      <HomeQuoteWrapper>
        <HomeQuote>
          "Quand l'art reste libre et garde une certaine spontanéité
          d'expression, au-delà du travail et de l'expérience acquise, se
          moquant des modes, du marché et ses spéculations, alors il est
          authentique !"
        </HomeQuote>
      </HomeQuoteWrapper>
    </Banner>
